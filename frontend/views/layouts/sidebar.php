...
<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
       <ul class="sidebar-menu tree" data-widget="tree">
          ...
          <li class="">
             <a href="<?=$base_url.'/contacts/index'?>">
             <i class="fa fa-phone-alt"></i>
                <span class="hovershow">Contact</span>
                <span class="bg-success btn-multicolor"><?=$contacts[0]['cnt']?></span>
             </a>
          </li>
          <li class="">
          ...
          <li class="">
             <a href="<?=$base_url.'/training/index'?>">
              <i class="fa fa-graduation-cap"></i>
                 <span class="hovershow">Training</span>
             </a>
          </li>
          <li class="">
          ...
          <li class="">
             <a href="<?=$base_url.'/resources/index'?>">              
               <i class="fas fa-coins"></i>
               <span class="hovershow">Resources</span>
             </a>
          </li>
          <li class="">
             <a href="<?=$base_url.'/user/default/index'?>">
          ...
          <li class="tech-support">
             <a href="<?=$base_url.'/support/index'?>" class="tech-support11">
