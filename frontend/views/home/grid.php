         ...
         <div class="button-tab-outer">
            <div class="tab-section-listing">
               ...
               <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" ><a href="#alllisting" aria-controls="profile" role="tab" data-toggle="tab">All Listing</a></li>
                  <?php /*
                     <li role="presentation" class="active"><a href="#active" aria-controls="messages" role="tab" data-toggle="tab">Active</a></li>
