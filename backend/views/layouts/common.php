...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 <?php echo $keyStorage->get('adminlte.sidebar-no-expand') ? 'sidebar-no-expand' : null ?>">
        <!-- brand logo -->
        <a href="<?=Url::base();?>" class="brand-link text-center <?php echo $keyStorage->get('adminlte.brand-text-small') ? 'text-sm' : null ?>">
                    ...
                    'items' => [
                        ...
                        /*[
                            ...
                            'active' => 'content' === Yii::$app->controller->module->id &&
                                ('user' === Yii::$app->controller->id || 'roll' === Yii::$app->controller->id),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Users'),
                                    'url' => ['/user/index'],
